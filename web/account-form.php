...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-6 mb-5">
            ...
            <a href="#" onclick="history.back()" class="btn btn-warning mt-5 mb-2"> Back</a>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <select name="headId" id="form-headId" class="form-select mt-2">
                                    ...
                                    <?php foreach ($headList as $row): ?> 
                                        <option value="<?=$row->Id?>"><?=$row->firstName?> <?=$row->lastName?> (<?=$row->company?>)</option>
                                     <?php endforeach; ?>
                                </select>
                            </div>
                            <?php endif; ?>
